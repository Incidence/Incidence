...
% (==> texte ?) : choisir si on le met ou pas
    \section{Moteur du Jeu}
      ...
      \subsection{Moteur multi-agent}
		...
		%(==> dans un ordre changeant pour plus de réalisme ?) Rep. : Normalement non car ça devra simulé du temps réel donc normalement toutes les entites agiront "en même temps"
        ...
        \subsubsection{Primitives}
          \begin{itemize} \small
            ...
            %\item (==> Construire un Bâtiment ?) Rep. : Non car pas de batiment
            %\item Soigner un Citoyen || Rep. : Pas de healer pour l'instant 
            %\item Naissance d'un Citoyen || Rep. : C'est pas un truc propre au entité
            %\item Changer le type d'une case ||Rep. : ça aussi c'est pas le citoyen
          \end{itemize} \normalsize
        ...
        \subsection{Moteur de rendu}
          ...
          % (==> Afin d'améliorer la vitesse de l'affichage, il est possible de créer une seule image constituée de toutes les tuiles... ?) Rep. : Oui et non, on utilisera les vertex array mais pas besoin de rentrer dans ce genre de detail dans le GDD
...
%------------------------------------------------------------------------------------
  ...
  \part{Univers du Jeu}
    ...
    \section{Les Cases}
	  ...
	  % Si flemme de le faire, mettez un modele, je le ferais
